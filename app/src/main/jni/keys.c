...
Java_com_kondenko_pocketwaka_api_KeysManager_getAppIdEncrypted(JNIEnv *env, jclass clazz) {
    return (*env) ->  NewStringUTF(env, "YidCU2RpemVHdHlhZ3JGWUc5cmg1aWw5cDEn");
}

JNIEXPORT jstring JNICALL
Java_com_kondenko_pocketwaka_api_KeysManager_getAppSecretEncrypted(JNIEnv *env, jclass clazz) {
