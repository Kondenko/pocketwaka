...
public class Stats implements Parcelable {
    ...
    public final static Parcelable.Creator<Stats> CREATOR = new Creator<Stats>() {
        ...
        public Stats createFromParcel(Parcel in) {
            ...
            in.readList(instance.editors, (Editor.class.getClassLoader()));
            ...
            in.readList(instance.languages, (Language.class.getClassLoader()));
            instance.modifiedAt = ((String) in.readValue((String.class.getClassLoader())));
            in.readList(instance.operatingSystems, (OperatingSystem.class.getClassLoader()));
            instance.project = in.readValue((Object.class.getClassLoader()));
            in.readList(instance.projects, (Project.class.getClassLoader()));
