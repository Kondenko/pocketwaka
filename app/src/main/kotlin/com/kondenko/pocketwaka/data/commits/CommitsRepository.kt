...
class CommitsRepository(private val context: Context, private val commitsService: CommitsService) : Repository<CommitsRepository.Params, Single<CommitsServiceModel>> {

    data class Params(val tokenHeader: String, val project: String, val author: String? = null, val page: Int? = null)

    override fun getData(params: Params): Single<CommitsServiceModel> =
