...
class FragmentStatsContainer : Fragment() {
    ...
    override fun onCreateView(inflater: LayoutInflater?, container: ViewGroup?,
        ...
        viewPager = view?.findViewById(R.id.viewpager_stats_tab_content) as ViewPager
        smartTabLayout = view?.findViewById(R.id.tablayout_stats_ranges) as SmartTabLayout
        return view
    }
